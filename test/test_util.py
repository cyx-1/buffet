...
def test_process_data_from_fred_success(mocker):
    ...
    mocker.patch('util.download_file_and_compare', return_value=Status(success=True, result='New file downloaded'))
...
def test_process_data_from_fred_error_cases(mocker):
    ...
    mocker.patch('util.download_file_and_compare', return_value=Status(success=False, result='Failed with status code 404'))
